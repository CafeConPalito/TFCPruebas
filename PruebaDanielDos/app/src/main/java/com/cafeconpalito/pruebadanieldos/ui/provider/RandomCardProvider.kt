package com.cafeconpalito.pruebadanieldos.ui.provider

import com.cafeconpalito.pruebadanieldos.R
import com.cafeconpalito.pruebadanieldos.ui.model.LuckyModel
...
class RandomCardProvider @Inject constructor() {
    ...
    /**
     * retorna una carta como el when no sabe seguro si lo lograra se le pone un return null
     * es necesario decirle que el LuckyModel Puede ser null el retorno
     */
    fun getLucky():LuckyModel?{ //LuckyModel con opcion de null
        ...
        return when(Random.nextInt(0,32)){
            ...
            //CODIGO INALCANZABLE.
            //El retorno del null para que el When deje de molestar
            else -> null
        }
